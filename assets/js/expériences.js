function light() {
    ...
    let classBG = document.querySelectorAll(".change_BG") //retourne un tableau d'element html
    let class_color_text_footer = document.querySelectorAll(".color_text_footer") //retourne un tableau d'element html
    let class_color_text_card = document.querySelectorAll(".color_text_card") //retourne un tableau d'element html
    ...
    if (toogle.value == "ON") {                   //si la valeur du bouton est ON quand on clique sur le bouton on applique les condition du light mode ci dessous
        ...
        for (let i = 0; i < classBG.length; i++) {
            console.log(classBG[i]);
            classBG[i].setAttribute('style', 'background-color : black !important');
        }
        for (let i = 0; i < class_color_text_card.length; i++) {
            console.log(class_color_text_card[i]);
            class_color_text_card[i].setAttribute('style', 'color : white !important');
        }
        ...
        for (let i = 0; i < classBG.length; i++) {
            console.log(classBG[i]);
            classBG[i].setAttribute('style', 'background-color : white !important');
        }
        for (let i = 0; i < class_color_text_card.length; i++) {
            console.log(class_color_text_card[i]);
            class_color_text_card[i].setAttribute('style', 'color : black !important');
        }
        for (let i = 0; i < class_color_text_footer.length; i++) {
            console.log(class_color_text_footer[i]);
